...
const one = 1;
const numerator = InterestRate * Math.pow(one + Interestrate, periods)
const denominator = Math.pow(one + Interestrate, periods) - one
...
function mortgageCalculator() {
    console.log (name, " your monthly rate is 1073.64" + "$", monthlyRate)
}
